...
def get_settings():
    ...
    return SystemSettings(
        ...
        enable_similarity_filter=s.enable_similarity_filter,
        similarity_filter_cutoff=s.similarity_filter_cutoff,
        enable_long_context_reorder=s.enable_long_context_reorder,
        reference_strategy=s.reference_strategy,
        response_mode=s.response_mode,
        use_ingestion_pipeline=s.use_ingestion_pipeline,
        enable_context_enrichment=s.enable_context_enrichment,
...
def update_settings(req: SettingsUpdateRequest):
    ...
    for key, value in updates.items():
        if key in (
            ...
            "embed_batch_size",
            "use_reranker",
            "enable_similarity_filter",
            "similarity_filter_cutoff",
            "enable_long_context_reorder",
            "reference_strategy",
            "response_mode",
            "use_ingestion_pipeline",
