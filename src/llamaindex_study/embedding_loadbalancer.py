...
class EmbeddingLoadBalancer:
    ...
    def add_endpoint(
        self, name: str, url: str, is_local: bool = False
    ...
    async def _health_check_endpoint(self, endpoint: Endpoint) -> bool:
        ...
        try:
            ...
            await asyncio.wait_for(
                embedder.aget_text_embedding("health check"), timeout=15
            )
            ...
            async with self._lock:
                ...
                endpoint.avg_latency = (
                    (endpoint.avg_latency + latency) / 2
        ...
        async def try_endpoint(endpoint: Endpoint):
            ...
            try:
                ...
                result = await asyncio.wait_for(
                    embedder.aget_text_embedding(text), timeout=60
                )
    ...
    def get_text_embedding(self, text: str) -> List[float]:
        ...
        try:
            embedder = create_ollama_embedding(
                model=self.model_name,
                base_url=endpoint.url,
            )
    ...
    def get_text_embeddings(self, texts: List[str]) -> List[List[float]]:
        ...
        with concurrent.futures.ThreadPoolExecutor(
            ...
            futures = {
                executor.submit(process_endpoint, assign): assign
...
def get_embedding_loadbalancer(
    ...
    if _global_lb is None:
        ...
        _global_lb.add_endpoint(
            "远程 3080", "http://192.168.31.63:11434", is_local=False
        )
